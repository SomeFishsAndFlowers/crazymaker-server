package com.jwl.common.constant;
...
public class SessionConstants
{
     ...
     * 用户id，作为session的身份标识
     */
    public static final String USER_IDENTIFIER = "USER-ID";

    /**
     * 用户端的 sessionId 键值前缀
     */
    public static final String SESSION_STORE = "FRONT-USER-END";

    /**
     * 管理控制台的 sessionId 键值前缀
     */
    public static final String ADMIN_SESSION_STORE = "BACK-ADMIN-END";
    /**
